...
export default function Home() {
  return (
    <main style={{background:"#000000"}}>
      ...
      <div className="flex justify-right text-9xl ml-40 mt-10">
        Launching <br /> Soon
      </div>
      <div className="ml-40 text-center text-xl text-justify mr-60">
      ...
      <button className="bg-neutral-950 mr-2 w-48 mt-5 uppercase py-2 px-3 cursor-pointer tracking-wider border-2
       border-yellow-300 hover:bg-transparent hover:text-yellow-300 hover:text-lg font-semibold"
        >CONTACT US</button>
      </div>
      </div>
      ...
      <div className="pt-20 flex justify-center">
        <h1 className="text-6xl "><strong>How to STV</strong></h1>
      
      </div>
      <div className="second flex h-screen">
      ...
      <div className="ml-60">
       ...
       <div className="hover:border-2 cursor-pointer w-1/3 p-3 mt-20">
       
       <h4 className="text-2xl hover:text-yellow-300"><strong>Download STV app</strong></h4>
       <p className="text-md">Download SVT from Appstore or Playstore</p>
      
       </div>
       <div className="hover:border-2 cursor-pointer w-1/3 mt-5 p-3">
      ...
      <div className="third flex h-screen">
      <div className="left w-1/2">
      <div className="ml-60">
      
       <div className="cursor-pointer p-3 mt-20">
       ...
       <div className="cursor-pointer p-3 mt-5 ">
